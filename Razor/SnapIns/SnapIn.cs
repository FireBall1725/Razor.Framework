...
{	
	/// <summary>
	/// This class is the base class for all SnapIns to inherit, otherwise they should implement ISnapIn
	/// </summary>
	[SnapInVisibility(false)]
	public class SnapIn : ISnapIn		
	{
		/// <summary>
		/// Initializes a new instance of the SnapIn class. The default constructor Windows Forms Designer.
		/// </summary>
		public SnapIn()
		{			
